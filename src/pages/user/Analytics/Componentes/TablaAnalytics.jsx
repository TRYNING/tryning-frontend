              ...
              <tbody>
                {
                  ...
                  <td className="px-2 sm:px-6 py-2 sm:py-2 text-center whitespace-no-wrap">{ejercicio.info.peso}</td>
                  <td className="px-2 sm:px-6 py-2 sm:py-2 text-center whitespace-no-wrap">{ejercicio.info.reps}</td>
                  <td className="px-2 sm:px-6 py-2 sm:py-2 text-center whitespace-no-wrap">{ejercicio.info.tonelaje}</td>
                </tr>)
                  })
                }
              </tbody>
