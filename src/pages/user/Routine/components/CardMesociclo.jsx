...
export function CardMesociclo({ id, description, weeks }) {
  return (
    <div className="flex flex-col min-w-[100px] mt-10" key={id}>
      <header className="flex items-center gap-2 grow-0  pt-5 pb-0 text-black">
      ...
      <main className="mt-5 flex flex-col gap-7">
