export function SvgHome({ size, color }) {
  return (
    <svg width={size} height={size} viewBox="0 0 27 29" fill={color}>
      <path
        fill="transparent"
...
export function SvgRoutine({ size, color }) {
  return (
    <svg width={size} height={size} viewBox="0 0 22 28" fill={color}>
      <path
        fill="transparent"
...
export function SvgMenu({ size }) {
  return (
    <svg width={size} height={size} fill="#111" viewBox="0 0 32 32">
...
export function SvgLupa({ size }) {
  return (
    <svg fill="#111" width={size} height={size} viewBox="0 0 32 32">
      <title />
...
export function SvgArgentina({ className }) {
